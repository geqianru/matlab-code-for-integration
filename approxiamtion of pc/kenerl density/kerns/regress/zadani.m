...
%         'between 0 and 1.                                    '];
hlpstr=['Firstly set the order and the smoothness of the kernel, ',...
        'which will be used for kernel estimation. The kernel will be ',...
        'of order (nu,k), nu < k, nu+k should be even. For an estimation ',... 
        'of a regression function use nu = 0. The parameter mu is the ',...
        'smoothness of this kernel, mu=-1 is for non-continuous kernel.',... 
