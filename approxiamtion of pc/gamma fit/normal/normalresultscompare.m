function [avg_gap,upper,lower,avg_sim,avg_a,Gap,avg_s,Gupper,Glower] = normalresultscompare(n,sigma_f,ed_f)
%global avg_s
%global Gap
%global avg_a
% global upper
...
avg_a = exnormalGn(n,sigma_f,ed_f);
display(avg_a);
sample_2 = 50;
%Gap = zeros(sample_2,1);
 for m = 1:sample_2
     display(m);
     avg_s(m) = exnormalMS(n,sigma_f,ed_f);
     display(avg_s(m));
