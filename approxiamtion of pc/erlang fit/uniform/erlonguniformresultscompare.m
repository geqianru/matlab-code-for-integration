function [avg_gap,upper,lower,pavg_sim,pavg_a,pavg_s,rel_gap,max_gap] = erlonguniformresultscompare(n,sigma_f,ed_f)
pavg_a = mixerlanguniformn(n,sigma_f,ed_f);
display(pavg_a);
sample_2 = 50;
 for m = 1:sample_2
     display(m);
     pavg_s(m) = exdownunisn(n,sigma_f,ed_f);
     display(pavg_s(m));
