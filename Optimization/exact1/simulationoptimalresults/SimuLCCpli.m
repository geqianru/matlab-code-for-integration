function [SimulationLCC] = SimuLCCpli(Opts) 
% the LCC under simulation evaluation (real costs) of given 'optimal' policy got from other model(deterministic) 
T = 10; 
ed_f = 1;
N = 30;
a1 = 10000;
...
SimulationLCC = simLCC(c_a,c_r,r,mu,sigma,D_0);
